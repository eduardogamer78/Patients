<template>
  <div class="q-pa-md">
    ...
    <q-toolbar>
      ...
      <q-space></q-space>
      <q-icon name="fas fa-calendar-minus" class="q-mr-sm" />
      <div class="text-overline">wedresday, 27.11.2022</div>
    </q-toolbar>
    <div class="row q-col-gutter-md top">
      <div class="col-3">
        <q-card class="q-mx-md" bordered>
          <div class="flex flex-center column">
            <q-circular-progress show-value font-size="12px" value="70" size="100px" :thickness="0.22" color="green-7" track-color="green-2" class="q-ma-md">
              70 patients
            </q-circular-progress>
            <div>
            ...
            <div>
              <q-badge color="green-2" rounded class="q-mr-sm" />Main 60%
            </div>
          </div>
        </q-card>
      </div>
      <div class="col-3">
        <q-card class="q-mx-md q-pa-md" bordered>
          <div class="text-overline">Wew patients</div>
        ...
        <q-card class="q-mx-md q-pa-md q-mt-md" bordered>
          <div class="text-overline">Old patients</div>
          <div class="flex flex-center row">
            <div class="text-h4 text-weight-bolder q-mr-md">32</div>
            <q-chip color="red-1" text-color="red-3" icon="fas fa-chevron-down">82%</q-chip>
          </div>
        </q-card>
      </div>
      <div class="col-6">
        <q-card class="q-mx-md q-pa-md doctors" bordered>
          ...
          <div class="">
            <q-carousel v-model="slide" vertical transition-prev="slide-down" transition-next="slide-up"
                swipeable animated control-color="green-7" navigation-icon="radio_button_unchecked" navigation padding
                arrows height="160px" class="text-black shadow-1 rounded-borders">
    ...
    <q-toolbar>
      ...
      <q-icon
          name="fas fa-chevron-right" size="10px" class="" color="green-7" />
    </q-toolbar>
